...
export function EditVideoForm({ video, categories }: EditVideoFormProps) {
  ...
  const onSubmit = async (data: FormInput) => {
    ...
    try {
      ...
      toast.error(err.message || 'Failed to update video story');
    } finally {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-3">
        ...
        <h1 className="text-lg font-bold text-zinc-900 dark:text-zinc-50">Edit Video Story</h1>
      </div>
